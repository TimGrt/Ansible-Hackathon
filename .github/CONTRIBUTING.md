...
Thank you for taking the time to contribute to the *Ansible Hackathon Guide*!
...
The *Ansible Hackathon Guide* should follow a common *style*, it should be easy to read and strive to explain good practices without being too technical (although explaining the technical reasoning behind a proposed practice should be done if necessary).  
